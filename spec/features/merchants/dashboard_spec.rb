...
describe 'merchant dashboard page' do
  before(:each) do
    ...
    InvoiceItem.create(item: @item1, invoice: @invoice1, status: 1, unit_price: 1000)
    InvoiceItem.create(item: @item2, invoice: @invoice2, status: 1, unit_price: 1000)
    InvoiceItem.create(item: @item3, invoice: @invoice2, status: 1, unit_price: 1000)
